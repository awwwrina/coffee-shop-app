    ...
    return (
        <>
            <section className="promo">
                ...
                <h2 className='promo__subheader'>We makes every day full of energy and taste
                    <br /><br />
            ...
            <section className="blends">
                <h2 className="blends__header">Discover our most popular blends</h2>
                <div className="bean">
                    <img src={ThreeBeans} alt="three beans" />
                </div>
                <p className="blends__subheader">Treat your friends & family to freshly roasted coffee from around the globe</p>
                
            </section>

            <section className="difference">
                <div className="difference__header">What makes us different?</div>
                <BlackBeans/>
                <p className="difference__descr">
            ...
            <section className="opinions">
                ...
                <Swiper
                    ...
                    <SwiperSlide className='card'>
                        <div className="card__header">Excellent taste</div>
                        <p className="card__descr">
                    ...
                    <SwiperSlide className='card'>
                        ...
                        <p className="card__descr">
                            I love to grind my own coffee fresh daily and I also love a bargain. If you have a vacuum packer then buying these large packages is a great way to save money. I portion it out, seal it in the bags, and freeze it until use. Word of advice, just be sure to let the bag completely thaw before opening to avoid getting the coffee wet from condensation. Why would anyone drive all the way to an expensive coffee shop to get their morning coffee when you can brew high quality coffee at home and be drinking it before you could even be ready to leave the house? I'm drinking a mug now. Ahhhh, that's good.
                        </p>
